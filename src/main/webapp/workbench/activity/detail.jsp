			...
			$.ajax({
				...
				success:function (data){
					...
					if (data.success){
						...
						html+= '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;"id="s'+data.ar.id+'">'+(data.ar.createTime)+'由'+(data.ar.createBy)+'创立'+'</small>';
		...
		$.ajax({
			...
			success:function (data){
				...
				$.each(data,function (i,n){
					...
					html+= '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="s'+n.id+'">'+(n.editFlag==0?n.createTime:n.editTime)+'由'+(n.editFlag==0?n.createBy:n.editBy)+'创立</small>';
					html+= '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
